...
public class Encryptor {
    ...
    private void generateEncyptionID() throws IOException {
        ...
        writer.write(encryptionID);
        System.out.println(encryptionID);
        writer.close();

        //making another file to make this method work only once...
        BufferedWriter writer1 = new BufferedWriter(new FileWriter("C:/Encryptor/temp.txt"));
        writer1.write("1");
        writer1.close();
    }
    ...
    public String Encrypt(String text) throws IOException {
        ...
        if (new File("C:/Encryptor/temp.txt").exists()) {
            reader = new BufferedReader(new FileReader("C:/Encryptor/temp.txt"));
